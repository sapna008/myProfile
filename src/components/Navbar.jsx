  ...
  return (
    <div className='fixed top-0 left-0 w-full bg-opacity-70 backdrop-blur-md z-50'>
        ...
        text-xl items-center px-12 h-20'>
            ...
            <a href="#">Sapna Sarkar</a>

            <ul className='hidden md:flex gap-12 z-10 cursor-pointer'>
                <li><Link to="skills" smooth={true} offset={50} duration={500} className='hover:text-[#12fdae]'>About</Link></li>
                <li><Link to="portfolio" smooth={true} offset={50} duration={500} className='hover:text-[#12fdae]'>Projects</Link></li>
                <li><Link to="contact" smooth={true} offset={50} duration={500} className='hover:text-[#12fdae] scale-10'>Contact</Link></li>
            </ul>
